...
namespace CPUScheduler 
{
    class Algorithms
    {
        ...
        public static double CalcTurnAroundTime(LinkedList<process> p)
        {
            process[] pp = new process[p.Count];
            p.CopyTo(pp, 0);
            double turnaround = 0;
            
            double[] turn = new double[p.Count];
            turn[0] = 0;
            for (int i = 0; i < p.Count; i++)
            {

                turn[i] = pp[i].getDeparture() - pp[i].getArrival();
                turnaround += turn[i];
            }
            return (turnaround / p.Count);
        }
        ...
        public static LinkedList<process> FCFS(List<process> p , out double waiting,out double TurnAround)
        {       
            ...
            TurnAround = CalcTurnAroundTime(sorted_processes);

          return sorted_processes ;
            
        }
        public static LinkedList<process> RoundRobin(double q, List<process> p, out double waiting, out double TurnAround)
        {
            double totalburst = 0.0;
            LinkedList<process> sorted_processes = new LinkedList<process>();
            List<process> SortedList = p.OrderBy(a => a.getArrival()).ToList();
        ...
        public static LinkedList<process> NonPreemptive_SJF(List<process> p, out double waiting, out double TurnAround)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
        ...
        public static LinkedList<process> NonPreemptive_Priority(List<process> p, out double waiting,out double TurnAround)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
        ...
        public static LinkedList<process> Preemptive_SJF(List<process> p, out double waiting, out double TurnAround)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
        ...
        public static LinkedList<process> Preemptive_Priority(List<process> p, out double waiting, out double TurnAround)
        {
            LinkedList<process> sorted_processes = new LinkedList<process>();
            List<process> SortedPriority = p.OrderBy(pr => pr.getPriority()).ToList();
