...
namespace OSS
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            LinkedList<process> output = Algorithms.FCFS(FCFS, out waitingtime, out turnaroundtime);
            Console.WriteLine(waitingtime);
            Form2 Chart = new Form2(waitingtime,output,turnaroundtime);
            Chart.Show();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            LinkedList<process> output = Algorithms.RoundRobin(q, RR, out waitingtime, out turnaroundtime);
            Console.WriteLine(waitingtime);
            Form2 Chart = new Form2(waitingtime, output, turnaroundtime);
            Chart.Show();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked) {
                output = Algorithms.Preemptive_SJF(SJF, out waitingtime, out turnaroundtime);
                Console.WriteLine(waitingtime);
                Form2 Chart = new Form2(waitingtime, output, turnaroundtime);
                Chart.Show();
            }
            ...
            {
                output = Algorithms.NonPreemptive_SJF(SJF, out waitingtime, out turnaroundtime);
                Console.WriteLine(waitingtime);
                Form2 Chart = new Form2(waitingtime, output, turnaroundtime);
                Chart.Show();
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                output = Algorithms.Preemptive_Priority(Priority, out waitingtime, out turnaroundtime);
                Console.WriteLine(waitingtime);
                Form2 Chart = new Form2(waitingtime, output, turnaroundtime);
                Chart.Show();
            }
            ...
            {
                output = Algorithms.NonPreemptive_Priority(Priority, out waitingtime, out turnaroundtime);
                Console.WriteLine(waitingtime);
                Form2 Chart = new Form2(waitingtime, output, turnaroundtime);
                Chart.Show();
            }
